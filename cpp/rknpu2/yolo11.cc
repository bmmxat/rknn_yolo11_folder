                          ...
                          float nms_threshold)
{
    ...
    // 使用传入的阈值参数
    post_process(app_ctx, outputs, &letter_box, conf_threshold, nms_threshold, od_results);
